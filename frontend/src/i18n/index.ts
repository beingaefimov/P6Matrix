...
const resources = {
  en: {
    translation: {
      ...
      no_project: 'No data', no_project_hint: 'Upload a .pxp or .xer file to get started',
      ...
      move_right: 'Indent',
      btn_share: 'MCP AI',
      btn_edraw_title: 'Export to Excalidraw',
      rename_activity: 'Rename activity',
      save: 'Save',
      btn_new_project: 'New Project',
      new_project_title: 'New Project',
      new_project_name_label: 'Project name',
      new_project_placeholder: 'Enter project name…',
      new_res_placeholder: 'Enter resource name…',
      create: 'Create',
      btn_new_resource: 'New Resource',
      new_resource_title: 'New Resource',
      resource_id_label: 'ID',
      resource_name_label: 'Name',
      max_units_label: 'Max Units',
      cost_per_unit_label: 'Cost/Unit',
      activity_start_name: 'Project Start',
      activity_finish_name: 'Project Finish',
      delete_resource_title: 'Delete Resource?',
      delete_resource_body: 'Resource and all its assignments will be removed. Remember to level resources separately afterwards',
      edit_resource_title: 'Edit Resource',
      edit_resource_warning: 'After saving, recalculate the schedule to apply changes',
    }
  },
  ru: {
    translation: {
      ...
      no_project: 'Нет данных', no_project_hint: 'Загрузите .pxp или .xer файл для начала работы',
      ...
      new_project_name_label: 'Название проекта',
      new_project_placeholder: 'Введите название…',
      new_res_placeholder: 'Введите название…',
      create: 'Создать',
      btn_new_resource: 'Новый ресурс',
      new_resource_title: 'Новый ресурс',
      resource_id_label: 'ID',
      resource_name_label: 'Название',
      max_units_label: 'Макс. единиц',
      cost_per_unit_label: 'Стоимость/ед.',
      activity_start_name: 'Начало проекта',
      activity_finish_name: 'Конец проекта',
      delete_resource_title: 'Удалить ресурс?',
      delete_resource_body: 'Ресурс и все его назначения будут удалены. Не забудьте выровнять ресурсы',
      edit_resource_title: 'Редактирование ресурса',
      edit_resource_warning: 'После сохранения пересчитайте расписание для применения изменений',
    }
  }
}
